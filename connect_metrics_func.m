function [strengths,cc,mcc,cpl,bc,eloc,meloc,ereg,eglob,small_worldness,cc_ratio,cpl_ratio,modularity,participation_thresh,Ci,n_comps,min_edge_weights] = connect_metrics_func(sparseness,binarize)
